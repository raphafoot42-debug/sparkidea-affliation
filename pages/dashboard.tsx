...
export default function Dashboard() {
  ...
  async function deleteSubAffiliate(sub: SubAffiliate) {
    if (!window.confirm(`Supprimer "${sub.name || sub.code}" ? Cette action est définitive. Si ce sous-affilié a déjà activé son propre compte, son compte reste actif — seule cette entrée de suivi disparaît.`)) {
      return
    }
    const { error } = await supabase
      .from('sub_affiliates')
    ...
    if (!error) {
      ...
      window.alert("Impossible de supprimer ce sous-affilié pour le moment. Réessaie, ou contacte l'équipe si ça persiste.")
    }
  }
                      ...
                      return (
                        <tr key={s.id}>
                          ...
                          <td style={{ textAlign: 'right' }}>
                            ...
                            <button className="btn-ghost" style={{ padding: '6px 12px', fontSize: 11, marginLeft: 6, borderColor: '#f87171', color: '#f87171' }} onClick={() => deleteSubAffiliate(s)} title="Supprimer définitivement">
                              🗑
                            </button>
                          </td>
          ...
          <section className="page active">
            ...
            <div className="card" style={{ marginBottom: 20 }}>
              ...
              <div style={{ fontSize: 12.5, color: 'var(--muted)', lineHeight: 1.7 }}>
                ...
                <br /><br />
                Tu commences avec un <b style={{ color: 'var(--text)' }}>CPA de 10€ par client</b>. Ce montant n&apos;est
                ...
                <br /><br />
                Concrètement : si tu ramènes 20 clients avec un CPA à 10€, tu touches <b style={{ color: 'var(--text)' }}>200€</b>,
                ...
                <br /><br />
                Important à savoir : si ton CPA change (par exemple de 10€ à 30€), ça ne s&apos;applique qu&apos;aux
